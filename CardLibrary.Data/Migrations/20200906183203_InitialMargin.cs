...
{
    public partial class InitialMargin : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoleLists", x => x.UserRoleId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCards", x => x.UserCardId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLists_UserGroups_UserGroupId",
                        column: x => x.UserGroupId,
                        principalTable: "UserGroups",
                        principalColumn: "UserGroupId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserLists_UserRoleLists_UserRoleId",
                        column: x => x.UserRoleId,
                        principalTable: "UserRoleLists",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserLists_UserGroupId",
                table: "UserLists",
                column: "UserGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLists_UserRoleId",
                table: "UserLists",
                column: "UserRoleId");
        }
